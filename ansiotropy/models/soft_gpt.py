...
parser.add_argument("--model", type=str, default='gpt2', help="We test both t5 and t5-lm in this scripts, the corresponding tokenizerwrapper will be automatically loaded.")
parser.add_argument("--model_name_or_path", default='sshleifer/tiny-gpt2')
